...
<body class="contact-page">
    ...
    <nav class="nav">
        ...
        <div class="nav__link hide">
            ...
            <a href="/vista-karting/contact">Contact</a>
...
<!---------------------------------    LANDING   ---------------------------------------->
    ...
    <div class="landing">
        <div class="mario-img">
            <img src="/vista-karting/img/vista-karting-homepage-mario.png" alt="">
        </div>
        <div class="mario-img-mobile">
            <img src="/vista-karting/img/vista-karting-homepage-mario-mobile.png" alt="">
        </div>
    </div>
